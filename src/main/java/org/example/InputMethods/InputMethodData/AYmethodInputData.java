...
public class AYmethodInputData {
    ...
    static {
        ...
        arrayInspiredElemsV1.put(DOUBLEBENT_55.val(), "g"); // ㇋ DOUBLEBENT_52
        arrayInspiredElemsV1.put(DOUBLEBENT_55_WITHHOOK.val(), "g"); //DOUBLEBENT_55_WITHHOOK("𠄎", true), //𠄎 eg 仍
        arrayInspiredElemsV1.put(DOUBLEBENT_52WITHHOOK.val(), "g"); //㇠
        arrayInspiredElemsV1.put(DOUBLEBENT_52NOHOOK.val(), "g"); //㇈ eg 凹
        ...
        //一 └	〡	十	┐	、	ㄇ	八＼	丿	口
            ...
            arrayInspiredElemsV1.put("心", "nh"); //n=6+6 x=2+6
            arrayInspiredElemsV1.put("忄", "nh"); //忄 short form of 心
        ...
        //一 └	〡	十	┐	、	ㄇ	八＼	丿	口
            //i k ,
            arrayInspiredElemsV1.put("金", "ik"); //飲欽
        ...
        arrayInspiredElemsV1.put("八", "k"); //k=8 //eg. 卻 stroke 1+2 and 3+4
            arrayInspiredElemsV1.put("火", "k."); //,=8+8 .=9+8
            arrayInspiredElemsV1.put("灬", "k."); //short form of 火
